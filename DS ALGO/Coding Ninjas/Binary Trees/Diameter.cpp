...
int diameter(Binary_Tree<int>*root){
    ...
    return max3(option1,option2,option3);
}
...
//DIAMETER IS THE LARGEST DISTANCE BETWEEN 2 NODES
...
/*
     ...
     4     5  
    6         7
    so the dimeter is the distance between the distance between 6 and 7=5
*/

/*
    so the diameter could be 3 things

    l_h+r_h(left height+right_height)
